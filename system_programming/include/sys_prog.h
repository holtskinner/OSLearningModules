...
// \param input_filename the file containing the data to be copied into the
// destination
// \param dst the variable that will be contain the copied contents from the
// file
// \param offset the starting location in the file, how many bytes inside the
// file I start reading
...
// Converts the endianess of the source data contents before storing into the
// dst_data.
// The passed source data bits are swapped from little to big endian and vice
// versa.
// \param src_data the source data that contains content to be stored into the
// destination
