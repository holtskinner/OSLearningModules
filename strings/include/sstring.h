...
// Finds the number of characters in the string, not including the null
// terminator
...
// Split the incoming string to tokens that are stored in a passed allocated
// tokens string array
// \param str the string that will be used for tokenization
// \param delims the delimiters that will be used for splitting the str into
// segments
// \param str_length the length of the str
// \param tokens the string array that is pre-allocated and will contain the
// parsed tokens
// \param max_token_length the max length of a token string in the tokens string
// array with null terminator
// \param requested_tokens the number of possible strings that tokens string
// array can contain
// \return returns the number of actual parsed tokens, 0 for incorrect params,
// and -1 for incorrect token allocation
